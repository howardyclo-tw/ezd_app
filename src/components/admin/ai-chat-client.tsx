      ...
      >
        <div className="flex items-end gap-2 rounded-3xl border border-white/10 bg-[#1A1A1C]/80 p-2 pl-4 transition-colors focus-within:border-primary/40">
          <textarea
            ...
            rows={1}
            placeholder="輸入問題…"
            className="min-h-[36px] max-h-[200px] flex-1 resize-none overflow-y-auto bg-transparent py-1.5 text-base leading-6 outline-none placeholder:text-muted-foreground sm:text-sm"
            disabled={busy}
          />
          <Button
            type="submit"
